...
window.onload = function () {
  ...
  document.getElementById("addRowBtn").addEventListener("click", function () {
      ...
      newRow.classList.add("bounce");
      setTimeout(() => newRow.classList.remove("bounce"), 1000);
  });
  ...
  document.getElementById("graph").addEventListener("change", function () {
      ...
      chart.render();
      document.getElementById("chartContainer").classList.add("slideIn");
      setTimeout(() => document.getElementById("chartContainer").classList.remove("slideIn"), 1000);
  });
